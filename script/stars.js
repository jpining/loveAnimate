var canDom = document.getElementById('starsCanvas');
var $ = canDom.getContext('2d');
var u = 0;
...
var go = function() {
  ...
  canDom.width = window.innerWidth;
  canDom.height = window.innerHeight;
  sc = Math.max(canDom.width, canDom.height);
  $.translate(canDom.width * 0.5, canDom.height * 0.5);
  $.scale(sc, sc);
